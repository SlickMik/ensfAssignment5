...
def book_data():
    ...
    for book in book_results:
        ...
        sale_prices.append(prices[-1] * 0.75)

    # Create a DataFrame using the two lists
    book_data = pd.DataFrame(list(zip(titles, prices, sale_prices)), columns=['Titles','Prices','Sale Price'])    
...
def learn():
    ...
    return "I learned how pandas can be used to manipluate massive amounts of data. This allows for coorelations " \
    "to be drawn. These coorelations can be used to predict how trends behave and allows for more informed decisions to be made"
    pass
